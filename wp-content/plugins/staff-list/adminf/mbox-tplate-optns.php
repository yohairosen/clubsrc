<?php
function abcfsl_mbox_tplate_optns(){
    ...
    abcfsl_v_tabs_optns_cntr_start(); //---Manager START
        abcfsl_mbox_tplate_optns_default_render_tabs();
        abcfsl_mbox_tplate_optns_default_render_cnt(  $tplateID, $tplateOptns, $pfix, $slug );
