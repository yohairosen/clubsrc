...
function abcfsl_admin_quick_start() {
    ...
    $tplateLayout = '1';
    $tplateName = '';
    echo abcfl_input_sec_title_hlp( ABCFSL_ICONS_URL, abcfsl_txta(80), abcfsl_aurl(0), 'abcflFontWP abcflFontS16 abcflFontW600 abcflMTop30' );
...
function abcfsl_admin_quick_start_create_template( $postType, $tplateTitle, $tplateLayout, $errTplate ) {
    ...
    abcfsl_autil_f_field_to_field_order( $postID, 'N', 'Y', 'F1' );
    abcfsl_autil_f_field_to_field_order( $postID, 'N', 'Y', 'F2' );
    abcfsl_autil_f_field_to_field_order( $postID, 'N', 'Y', 'F3' );
    abcfsl_autil_f_field_to_field_order( $postID, 'N', 'Y', 'F4' );
    abcfsl_autil_f_field_to_field_order( $postID, 'N', 'Y', 'F5' );
    abcfsl_autil_f_field_to_field_order( $postID, 'N', 'S', 'F6' );
    abcfsl_autil_s_field_to_field_order( $postID, 'Y', 'L', 'SPTL' );
