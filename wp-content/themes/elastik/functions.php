...
function elastik_scripts() {
    ...
    function load_css() {
        wp_enqueue_style( 'add_google_fonts', 'https://fonts.googleapis.com/css?family=Merriweather:400,900&display=swap' );
        wp_enqueue_style( 'add_google_fonts', 'https://fonts.googleapis.com/css?family=Archivo:400,400i,500,500i,600,600i,700,700i&display=swap' );
        wp_enqueue_style ('bootstrap', get_template_directory_uri().'/css/bootstrap.min.css');
        wp_enqueue_style ('candidate-style', get_template_directory_uri().'/css/candidate-style.css');
        wp_enqueue_style ('iconmoon-style', get_template_directory_uri().'/css/iconmoon.css');
    }
